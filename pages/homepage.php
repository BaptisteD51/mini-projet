...
<div>
    ...
    <p>Ce site a vocation à vous faire découvrir les subtilités de HTML5 et CSS3, grâce à deux courants artistiques : le Bauhaus et le mouvement psychédélique, ça vous parle ?</p>
...
<div class="bauhauskesako">
    ...
    <p>Mais alors, le Bauhaus, qu'est que c'est ? Vous imaginez peut-être les bâtiments construits en béton, très sobre et très présents en Europe de l'Est. Mais en réalité c'est bien plus que ça !</p>
...
<div class="psychekesako">
    <p>Vous connaissez certainement le mouvement hippie non ? Et bien disons que le psychédélique en est un enfant. Très influencé par la musique rock, le mouvement hippie essaie de s'émanciper des valeurs traditionnelles américaines.</p>
    <p>Ils essaient de s'ouvrir à de nouvelles cultures, comme la culture amérindienne et s'efforce à construire un mode de vie alternatif.</p>
